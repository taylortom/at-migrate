...
export default class Importer {
  ...
  async init() {
    ...
    const { App } = await import(pathToFileURL(path.resolve(this.newToolPath, 'node_modules/adapt-authoring-core/index.js')));
  ...
  async importUsers() {
    /**
     * @todo should we allow for existing users with the same email?
     */
